...
class oiIssueOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from orange_inventory.orange_inventory.doctype.oiissueorderitem.oiissueorderitem import (
			oiIssueOrderItem,
		)
		...
		from_organization_filter: DF.Check
	...
	def on_validate(self):
		...
		for item in self.items:
			...
			asset_data = frappe.db.get_value(
				"oiAsset", item.asset, ["quantity", "current_owner", "asset_name"], as_dict=True
			)
